...
import type { SocialProvidersProps, SocialProvider } from './types'
    ...
    <div>
      ...
      <div className="relative my-6">
        <div className="absolute inset-0 flex items-center">
          <div className="w-full border-t border-[rgba(184,164,142,0.25)]" />
        </div>
        <div className="relative flex justify-center text-xs">
          <span className="bg-white px-3 text-[#8A847A]">{dividerText}</span>
        </div>
      </div>
