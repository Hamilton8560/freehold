...
export interface CheckoutFullScreenProps extends HTMLAttributes<HTMLDivElement> {
  header?: CheckoutHeaderConfig
  footer?: CheckoutFooterConfig
}

export const CheckoutFullScreen = forwardRef<HTMLDivElement, CheckoutFullScreenProps>(
