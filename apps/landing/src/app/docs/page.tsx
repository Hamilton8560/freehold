    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-text-secondary">
          Select a component from the sidebar to view its documentation, props, and examples.
        </p>
      </div>
  ...
  return (
    <div className="border border-[rgba(184,164,142,0.25)] rounded-lg bg-white overflow-hidden">
      ...
      <button
        ...
        className="w-full px-4 py-2 text-sm text-text-tertiary hover:text-text-secondary border-t border-[rgba(184,164,142,0.15)]"
      >
        Close
      </button>
    </div>
